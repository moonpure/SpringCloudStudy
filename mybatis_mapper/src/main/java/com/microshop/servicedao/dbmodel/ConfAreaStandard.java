...
public class ConfAreaStandard {
    ...
    private Boolean areaRank;

    private String areaZipcode;

    private String confoldAreaNo;
    ...
    public Boolean getAreaRank() {
        return areaRank;
    }

    public void setAreaRank(Boolean areaRank) {
    ...
    public String getConfoldAreaNo() {
        return confoldAreaNo;
    }

    public void setConfoldAreaNo(String confoldAreaNo) {
        this.confoldAreaNo = confoldAreaNo == null ? null : confoldAreaNo.trim();
    }
}